			...
			<div class="col-md-10">
				...
				<c:forEach items="${requestScope.hotProductList }" var="hotProduct">
					<div class="col-md-2"
						...
						<a
							href="${pageContext.request.contextPath }/product?method=productInfoByPid&pid=${hotProduct.pid}">
							<img
						...
						<p>
							<a
								href="${pageContext.request.contextPath }/product?method=productInfoByPid&pid=${hotProduct.pid}"
								style='color: #666'>${hotProduct.pname }</a>
						</p>
						<p>
			...
			<div class="col-md-10">
				...
				<c:forEach items="${requestScope.newProductList }" var="newProduct">
					<div class="col-md-2"
						style="text-align: center; height: 200px; padding: 10px 0px;">
						<a
							href="${pageContext.request.contextPath }/product?method=productInfoByPid&pid=${newProduct.pid}">
							<img
						...
						<p>
							<a
								href="${pageContext.request.contextPath }/product?method=productInfoByPid&pid=${newProduct.pid}"
								style='color: #666'>${newProdcut.pname }</a>
						</p>
						<p>
