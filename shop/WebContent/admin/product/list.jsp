...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
			function addProduct(){
				window.location.href = "${pageContext.request.contextPath}/admin?method=getCategory";
			}
...
<body>
	<br>
	<form action="${pageContext.request.contextPath }/admin?method=searchProduct" method="post"><b>
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${pageBean.dataList }" var="product" varStatus="vs" >
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${ pageContext.request.contextPath }/admin?method=editProductUI&pid=${product.pid}">
											<img
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
			...
			<c:if test="${pageBean.page!=1 }">
				<li>
					<a href="${pageContext.request.contextPath }/admin?method=searchProduct&page=${pageBean.page-1}&pname=${condition.pname}&is_hot=${condition.is_hot}&cid=${condition.cid}" aria-label="Previous">
						<span aria-hidden="true">&laquo;</span>
					</a>
				</li>
			</c:if>
			...
			<c:forEach begin="1" end="${pageBean.totalPage }" var="pageNum">
				<c:if test="${pageBean.page==pageNum }">
					<li class="active"><a href="javascript:void(0)">${pageNum }</a></li>
				</c:if>
				<c:if test="${pageBean.page!=pageNum }">
					<li><a href="${pageContext.request.contextPath }/admin?method=searchProduct&page=${pageNum}&pname=${condition.pname}&is_hot=${condition.is_hot}&cid=${condition.cid}">${pageNum }</a></li>
				</c:if>
			</c:forEach>
			<!-- 下一页 -->
			...
			<c:if test="${pageBean.page!=pageBean.totalPage }">
				<li>
					<a href="${pageContext.request.contextPath }/admin?method=searchProduct&page=${pageBean.page+1 }&pname=${condition.pname}&is_hot=${condition.is_hot}&cid=${condition.cid}" aria-label="Next"> 
						<span aria-hidden="true">&raquo;</span>
					</a>
				</li>
			</c:if>
