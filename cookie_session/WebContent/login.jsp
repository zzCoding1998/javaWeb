...
<script>
	...
	window.onload=function(){
		...
		checkImg.src = "/cookie_session/checkImg?time="+new Date().getTime();
	}
		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<form class="form-horizontal" action="/cookie_session/login" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<img src="/cookie_session/checkImg"  onclick="changeImg()" id="checkImg"/>
							</div>
						</div>
						<div class="form-group">
