...
<%@ taglib prefix="zz" uri="http://zz.com/common/"%>
<%
					...
					<form class="form-inline" action="${pageContext.request.contextPath }/customer/list.action" method="post">
						...
						<div class="form-group">
							...
							<select	class="form-control" id="customerFrom" placeholder="客户来源" name="cust_source">
								...
								<c:forEach items="${customerOriginList}" var="item">
						...
						<div class="form-group">
							...
							<select	class="form-control" id="custIndustry"  name="cust_industry">
								<option value="">--请选择--</option>
								<c:forEach items="${customerIndustryList}" var="item">
						...
						<div class="form-group">
							...
							<select	class="form-control" id="custLevel" name="cust_level">
								<option value="">--请选择--</option>
								<c:forEach items="${customerLevelList}" var="item">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<zz:page url="${pageContext.request.contextPath }/customer/list.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
